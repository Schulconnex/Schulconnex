  ...
  apiQuellsystemeSidebarOpenAPIDocs: [
    {
      ...
      items: [
        ...
        {
          type: 'category',
          label: 'Bewertungslisten',
          items: [
            {
              type: 'doc',
              id: 'generated/openapi/quellsysteme/create-bewertungsliste',
              label: '/bewertungslisten',
              key: 'create-bewertungsliste',
              className: 'api-method post',
            },
            {
              type: 'doc',
              id: 'generated/openapi/quellsysteme/read-bewertungslisten',
              label: '/bewertungslisten', 
          ...
          items: [
            {
              ...
              label: '/bewertungen/\u200B:id',
              key: 'read-bewertung-id',
              className: 'api-method get',
            },
            {
              type: 'doc',
              id: 'generated/openapi/quellsysteme/delete-bewertungen-id',
              label: '/bewertungen/\u200B:id',
              key: 'delete-bewertung-id',
              className: 'api-method delete',
            },
          ],
        },
