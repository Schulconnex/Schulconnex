...
const sidebars = {
  ...
  apiDiensteSidebarPaloAlto: [
    {
      type: 'category',
      label: 'API Dienste',
      link: {
        type: 'doc',
        id: 'schulconnex-api-by-plugin/dienste/schulconnex',
      },
      items: [
        'schulconnex-api-by-plugin/dienste/die-schnittstelle-person-info-bezieht-sich-auf-die-information-einer-person',
      ],
    },
  ],

  apiQSSidebarPaloAlto: [{type: 'autogenerated', dirName: 'schulconnex-api-by-plugin/qs'}],
};
