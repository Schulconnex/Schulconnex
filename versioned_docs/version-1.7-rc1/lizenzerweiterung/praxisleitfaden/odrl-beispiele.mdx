...
<Tabs groupId="accept-type" queryString>
  <TabItem value="json" label="JSON">
    <CodeBlock language="json" title="Beispiel für ein ausführbares Programm" showLineNumbers>{Einzellizenz}</CodeBlock>
  </TabItem>
  <TabItem value="json-ld" label="JSON LD">
    <CodeBlock language="json" title="Beispiel für ein ausführbares Programm" showLineNumbers>{EinzellizenzLD}</CodeBlock>
  </TabItem>
</Tabs>
...
<Tabs groupId="accept-type" queryString>
  <TabItem value="json" label="JSON">
    <CodeBlock language="json" title="Beispiel für eine Schullizenz" showLineNumbers>{Schullizenz}</CodeBlock>
  </TabItem>
  <TabItem value="json-ld" label="JSON LD">
    <CodeBlock language="json" title="Beispiel für eine Schullizenz" showLineNumbers>{SchullizenzLD}</CodeBlock>
  </TabItem>
</Tabs>
...
<Tabs groupId="accept-type" queryString>
  <TabItem value="json" label="JSON">
    <CodeBlock language="json" title="Beispiel für eine Lehrerlizenz" showLineNumbers>{Lehrerlizenz}</CodeBlock>
  </TabItem>
  <TabItem value="json-ld" label="JSON LD">
    <CodeBlock language="json" title="Beispiel für eine Lehrerlizenz" showLineNumbers>{LehrerlizenzLD}</CodeBlock>
  </TabItem>
</Tabs>
...
<Tabs groupId="accept-type" queryString>
  <TabItem value="json" label="JSON">
    <CodeBlock language="json" title="Beispiel für eine Gruppenlizenz" showLineNumbers>{Gruppenlizenz}</CodeBlock>
  </TabItem>
  <TabItem value="json-ld" label="JSON LD">
    <CodeBlock language="json" title="Beispiel für eine Gruppenlizenz" showLineNumbers>{GruppenlizenzLD}</CodeBlock>
  </TabItem>
</Tabs>
...
<Tabs groupId="accept-type" queryString>
  <TabItem value="json" label="JSON">
    <CodeBlock language="json" title="Beispiel für ein gestreamtes Medium" showLineNumbers>{AVMedium}</CodeBlock>
  </TabItem>
  <TabItem value="json-ld" label="JSON LD">
    <CodeBlock language="json" title="Beispiel für ein gestreamtes Medium" showLineNumbers>{AVMediumLD}</CodeBlock>
  </TabItem>
</Tabs>
...
<Tabs groupId="accept-type" queryString>
  <TabItem value="json" label="JSON">
    <CodeBlock language="json" title="Beispiel für ein bearbeitbares Office-Dokument" showLineNumbers>{Arbeitsblatt}</CodeBlock>
  </TabItem>
  <TabItem value="json-ld" label="JSON LD">
    <CodeBlock language="json" title="Beispiel für ein bearbeitbares Office-Dokument" showLineNumbers>{ArbeitsblattLD}</CodeBlock>
  </TabItem>
</Tabs>
...
<Tabs groupId="accept-type" queryString>
  <TabItem value="json" label="JSON">
    <CodeBlock language="json" title="Beispiel für eine Schuljahreslizenz" showLineNumbers>{Schuljahreslizenz}</CodeBlock>
  </TabItem>
  <TabItem value="json-ld" label="JSON LD">
    <CodeBlock language="json" title="Beispiel für eine Schuljahreslizenz" showLineNumbers>{SchuljahreslizenzLD}</CodeBlock>
  </TabItem>
</Tabs>
...
<Tabs groupId="accept-type" queryString>
  <TabItem value="json" label="JSON">
    <CodeBlock language="json" title="Beispiel für eine kreisweit gültige Lizenz" showLineNumbers>{Landkreis}</CodeBlock>
  </TabItem>
  <TabItem value="json-ld" label="JSON LD">
    <CodeBlock language="json" title="Beispiel für eine kreisweit gültige Lizenz" showLineNumbers>{LandkreisLD}</CodeBlock>
  </TabItem>
</Tabs>
...
<Tabs groupId="accept-type" queryString>
  <TabItem value="json" label="JSON">
    <CodeBlock language="json" title="Beispiel für eine dynamisch zugeteilte Lizenz" showLineNumbers>{Dynamisch}</CodeBlock>
  </TabItem>
  <TabItem value="json-ld" label="JSON LD">
    <CodeBlock language="json" title="Beispiel für eine dynamisch zugeteilte Lizenz" showLineNumbers>{DynamischLD}</CodeBlock>
  </TabItem>
</Tabs>
...
<Tabs groupId="accept-type" queryString>
  <TabItem value="json" label="JSON">
    <CodeBlock language="json" title="Beispiel für eine Kombination von Lizenzbedingungen" showLineNumbers>{Kombiniert}</CodeBlock>
  </TabItem>
  <TabItem value="json-ld" label="JSON LD">
    <CodeBlock language="json" title="Beispiel für eine Kombination von Lizenzbedingungen" showLineNumbers>{KombiniertLD}</CodeBlock>
  </TabItem>
</Tabs>
