...
<Tabs groupId="accept-type" queryString>
  <TabItem value="json" label="JSON">
    <CodeBlock language="js" title="Beispiel für ein ausführbares Programm" >{Einzellizenz}</CodeBlock>
  </TabItem>
  <TabItem value="json-ld" label="JSON LD">
    <CodeBlock language="js" title="Beispiel für ein ausführbares Programm" >{EinzellizenzLD}</CodeBlock>
  </TabItem>
</Tabs>
