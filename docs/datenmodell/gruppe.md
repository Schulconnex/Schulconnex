...
laufzeit.bis | Datum (siehe Abschnitt Datumsformat) | 0..1 | Ende des Gültigkeitszeitraumes der Gruppe. Ende der Gruppenzugehörigkeit. Laufzeiten schliessen den ersten und letzten Tag immer mit ein. Ist als  `laufzeit.bis` der 31.Oktober 2025 angegeben, so endet die Gruppe am 01.11.2025 um 00:00.
