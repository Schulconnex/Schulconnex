...
Organisation bezieht, gruppenspezifische Rollen angegeben. So kann beispielsweise jemand in einer
...
rollen | String (Code) | 1..n | Rolle der Person innerhalb der Gruppe. Referenz auf Liste von Rollen der Codeliste *Gruppenrolle*.
