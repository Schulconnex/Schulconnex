...
lokalisierung | String | 0/0..1 | ja | Bevorzugte Lokalisierungseinstellung einer Person für Anwendungen. Wert basiert auf Definition in [RFC 5646][1]. Wenn nicht angegeben, wird „de“ angenommen.
