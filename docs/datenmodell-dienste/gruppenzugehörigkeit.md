...
--- | --- | --- | --- | --- | ---
personenkontext | String (Code) | 0/1 | ja | Pseudonymisierte ID des Personenkontexts. |
rollen | String (Code) | 0/1..n | ja | Rollen der Person innerhalb der Gruppe. Liste von Rollen nach Codeliste *Gruppenrolle*. | `urn:schulconnex:de:kern:gruppenzugehoerigkeit:rollen`
von | String (Code) | 0/1..n | ja | Beginn der Gruppenzugehörigkeit. Dieser Zeitpunkt kann auch in der Zukunft liegen. | `urn:schulconnex:de:kern:gruppenzugehoerigkeit:von`
bis | String (Code) | 0/1..n | ja | Ende der Gruppenzugehörigkeit. | `urn:schulconnex:de:kern:gruppenzugehoerigkeit:bis`
