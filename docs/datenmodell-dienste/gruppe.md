...
organisation | String (UTF-8) | 0/0..1 | ja | ID der Organisation, welcher die Gruppe zugeordnet ist. | `urn:schulconnex:de:gruppe:organisation`
bezeichnung | String (UTF-8) | 0/1 | ja | Bezeichnung der Gruppe, beispielsweise „Englisch, 2. Klasse". | `urn:schulconnex:de:gruppe:bezeichnung`
