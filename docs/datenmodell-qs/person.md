...
mandant | String (UTF-8) | 1 | ID des Mandanten, dem die Personen zugeordnet ist. Wird vom Schulconnex-Server vergeben und ist eindeutig. | `urn:schulconnex:de:person:mandant`
...
geburt | *[Geburt](geburt)* | 0..1 | Information zu Geburtsdatum und Geburtsort der Person. | `urn:schulconnex:de:person:geburt`
