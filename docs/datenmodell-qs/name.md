...
name.anrede | String (64/512) (DIN 91379.B) | 0..n | Liste (Array) von Namenszusätzen bei der Anrede. Jeder einzelne Namenszusatz hat eine Maximallänge von 64 Zeichen, die Maximallänge für alle Namenszusätze liegt bei 512 Zeichen. Es ist zu beachten, dass die Reihenfolge der Anreden im Array nicht spezifiziert ist. Soll sichergestellt werden, dass die Reihenfolge nicht verändert wird, so kann die komplette Anrede auch in nur einem Feld übermittelt werden („Frau Bundeskanzlerin“, „Herr Botschafter“).
