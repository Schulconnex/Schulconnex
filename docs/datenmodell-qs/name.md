...
name.namenssuffix | String (64/1024) (DIN 91379.A) | 0..n | Liste (Array) von Namensuffixen. Jeder einzelne Namenssuffix hat eine Maximallänge von 64 Zeichen, die Maximallänge für alle Namensuffixe liegt bei 1024 Zeichen. Die Reihenfolge von Suffixen in Arrays ist nicht spezifiziert. Die Anwendungen sind dafür verantwortlich, dass mehrere Suffixe sinnvoll dargestellt werden.
